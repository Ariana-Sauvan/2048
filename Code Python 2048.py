# Créé par Administrator, le 24/01/2022 en Python 3.7
"""
Programme du jeu 2048
Réaliser par : Matthys Tachon-Panafieu, Ariana Sauvan, Benjamin Corral

NOTE ! : Pour le multijoueur, pour lancer la deuxième parti, fermé TOUTE les fenêtres, merci !
"""
from tkinter import *
...
class DefaultBoardX4:
    ...
    """
    bg_color={#couleur de font des blocks
        '2': '#eee4da',
        '4': '#ede0c8',
        '8': '#edc850',
        '16': '#edc53f',
...
class LightBoardX4:
    """
    2048 en tableau x4, avec des lumières clair
    """
    bg_color={#couleur de font des blocks
        '2': '#eee4da',
        '4': '#ede0c8',
...
class DarkBoardX4:
    """
    2048 en tableau x4, avec des lumières sombre
    """
    bg_color={#couleur de font des blocks
        '2': '#392a1a',
        '4': '#473717',
...
class LightBoardX8:
    """
    2048 en tableau x8, avec des lumières clair
    """
    bg_color={#couleur de font des blocks
        '2': '#eee4da',
        '4': '#ede0c8',
...
class fin :
    ...
    def __init__(self, gamepanel, gamepanel2):
        ...
        if gamepanel.score > gamepanel2.score :
            label = Label(self.window, text= "J1 won", font=('arial', 22, 'bold'), pady = 30)
            label.pack()
        elif gamepanel.score < gamepanel2.score :
            label = Label(self.window, text= "J2 won", font=('arial', 22, 'bold'), pady = 30)
            label.pack()
        else :
            label = Label(self.window, text= "Equality", font=('arial', 22, 'bold'), pady = 30)
            label.pack()
...
class Interface1:
    ...
    def __init__(self):
        ...
        def lunchdefaultx4():
            """
            Si l'utilisateur appuie sur le bouton 2048 x4, permet de lancer le jeu
            """
        ...
        def lunchdefaultx8():
            """
            Si l'utilisateur appuie sur le bouton 2048 x8, permet de lancer le jeu
            """
        ...
        def lunchdefaultmultiplayerx4():
            """
            Si l'utilisateur appuie sur le bouton 2048 x4 multiplayers, permet de lancer le jeu
            """
            gamepanel = DefaultBoardX4()
            game2048 = DefaultGameX4(gamepanel)
            game2048.start()
        ...
        def lunchdefaultmultiplayerx8():
            """
            Si l'utilisateur appuie sur le bouton 2048 x8 multiplayers, permet de lancer le jeu
            """
            gamepanel = DefaultBoardX8()
            game2048 = DefaultGameX8(gamepanel)
            game2048.start()
        ...
        label = Label(tkWindow,text='What do you want to do ?',
...
class Interface2:
    ...
    def __init__(self):
        ...
        def lunchlightx4():
            """
            Si l'utilisateur appuie sur le bouton 2048 x4 light, permet de lancer le jeu
            """
        ...
        def lunchdarkx4():
            """
            Si l'utilisateur appuie sur le bouton 2048 x4 dark, permet de lancer le jeu
            """
        ...
        def lunchlightx8():
            """
            Si l'utilisateur appuie sur le bouton 2048 x8 light, permet de lancer le jeu
            """
        ...
        def lunchdarkx8():
            """
            Si l'utilisateur appuie sur le bouton 2048 x8 dark, permet de lancer le jeu
            """
        ...
        def lunchlightmultiplayerx4():
            """
            Si l'utilisateur appuie sur le bouton 2048 x4 light multiplayers, permet de lancer le jeu
            """
            gamepanel = LightBoardX4()
            game2048 = DefaultGameX4(gamepanel)
            game2048.start()
        ...
        def lunchdarkmultiplayerx4():
            """
            Si l'utilisateur appuie sur le bouton 2048 x4 dark multiplayers, permet de lancer le jeu
            """
            gamepanel = DarkBoardX4()
            game2048 = DefaultGameX4(gamepanel)
            game2048.start()
        ...
        def lunchlightmultiplayerx8():
            """
            Si l'utilisateur appuie sur le bouton 2048 x8 light multiplayers, permet de lancer le jeu
            """
            gamepanel = LightBoardX8()
            game2048 = DefaultGameX8(gamepanel)
            game2048.start()
        ...
        def lunchdarkmultiplayerx8():
            """
            Si l'utilisateur appuie sur le bouton 2048 x8 dark muliplayers, permet de lancer le jeu
            """
            gamepanel = DarkBoardX8()
            game2048 = DefaultGameX8(gamepanel)
            game2048.start()
        ...
        label = Label(tkWindow,text='What theme do you want ?',
            font=('arial',22,'bold'), pady=30)
        label.pack()
